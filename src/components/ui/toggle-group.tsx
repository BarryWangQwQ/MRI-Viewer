...
// Relative on purpose: `toggleVariants` appears in exported type positions, so
// the `@/` alias would survive into the published .d.ts and fail to resolve for
// consumers. Value-only imports like `cn` never reach the declarations.
