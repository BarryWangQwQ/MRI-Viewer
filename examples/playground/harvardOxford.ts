/**
 * Harvard–Oxford cortical labels (FSL HOCPA / TemplateFlow atlas-HOCPA).
 * Background is 0. Source: tpl-MNI152NLin6Asym_atlas-HOCPA_dseg.tsv
 * https://fsl.fmrib.ox.ac.uk/fsl/fslwiki/Atlases
 */
export const HARVARD_OXFORD_CORTICAL: Record<number, string> = {
  1: 'Frontal Pole',
  2: 'Insular Cortex',
